...
<template>
    <nav class="relative z-30">
        <div id="top-bar" class="flex justify-around items-center p-2">
            <router-link v-if="checkWindowSize" to="/tudor" class="cursor-pointer ">
                <img src="/assets/tudor-retailer.jpg" alt="tudor-retailer-badge" class="w-24 md:w-32">
            </router-link>
            <router-link to="/" class="w-fit">
                <img src="/assets/mimi-logo.png" alt="mimi-joyeria-logo" class="w-24 md:w-full h-12 md:h-28 ">
            </router-link>
            <div class="relative items-center hidden md:flex">
                <router-link v-if="checkWindowSize" to="/rolex" class=" cursor-pointer absolute z-10 block md:w-40 md:h-20">
                </router-link>
                <iframe
