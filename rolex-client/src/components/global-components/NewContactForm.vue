...
<template>
    ...
    <div id="main-contact" :class="Color" class="py-10 flex flex-col items-center ">
            ...
            <div id="row" class="py-2 flex flex-col gap-2 md:flex-row w-full">
                <div class="flex flex-col w-full text-rolex-brown">
                    ...
                    <Field as="select" name="tto" id="tto"
                        :class="Color" class="h-10 p-2 bg-rolex-brown-light-2 border-b font-helvetica font-bold border-rolex-brown"
                        v-model="model.tto">
                ...
                <div class=" w-full">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <Field id="phonecode" type="number" name="phonecode" placeholder="00"
                            :class="Color" class="h-10 p-2 bg-rolex-brown-light-2 border-b font-helvetica font-bold border-rolex-brown w-16  "
                            v-model="phoneNumber.code" />
                        <Field id="phonenumber" type="number" name="number" placeholder="4245556666"
                            :class="Color" class="h-10 p-2 bg-rolex-brown-light-2 border-b font-helvetica font-bold border-rolex-brown w-full "
