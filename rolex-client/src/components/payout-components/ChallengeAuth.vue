...
<template>
    <div id="challenge" class="z-40 fixed h-screen top-0 w-full flex  items-center justify-center bg-black/60" v-if="iframe">
        <div class="relative" >

            <iframe id="form" name="step-up-iframe" :class="sizes[link.challengeWindowSize]" class="bg-white"
               ></iframe>
