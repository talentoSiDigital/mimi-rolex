      ...
      <div class="">
        ...
        <div>
          ...
          <h2 class="font-bold text-sm">
            *La Dirección debe ser tal como aparece en los registros del emisor
        ...
        <div>
          <label for="year" class="block mb-1 text-sm font-medium text-gray-900"
            >País</label
          >
          <SelectInput
        ...
        <div>
          ...
          <RegionsInput
            v-model="dataToSend.region"
            :country="dataToSend.country"
            class="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
          />
          <div class="h-6">
            <h2 v-if="regionWarn" class="text-red-700 text-sm">
              Debes seleccionar una region
            </h2>
          </div>
        </div>
