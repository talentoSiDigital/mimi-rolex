      ...
      >
        ...
        >
          ...
          <div class="flex flex-col items-center overflow-scroll">
            ...
            <Transition>
              <div
                class="grid grid-cols-3 content-center w-10/12"
                v-if="cookieLog"
              >
        ...
        <div
          class="flex flex-col items-center justify-center w-1/3 gap-2 h-3/5 md:h-full"
        >
          <button
