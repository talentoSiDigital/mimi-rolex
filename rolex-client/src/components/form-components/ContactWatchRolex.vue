...
<template>
  <div id="main-contact" class="my-10 flex flex-col items-center">
    ...
    <p class="mb-4 text-center">
      Le rogamos que nos especifique su forma de contacto deseada y le
    ...
    >
      ...
      <div id="row" class="py-2 flex flex-col">
        ...
        <Field
          ...
          class="border border-[#bbb] max-h-52 min-h-min h-24 p-4"
      ...
      <div id="row">
        ...
        />
        <label for="optional">
          Acepto recibir información comercial sobre Rolex de Mimi
          Joyería</label
        >
      </div>
