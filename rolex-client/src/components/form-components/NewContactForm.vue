    ...
    >
      <div id="row" class="py-2 flex flex-col gap-2 md:flex-row w-full">
        ...
        <div class="flex flex-col w-full">
          <label for="nombre" class="text-[#ad988e] font-helvetica font-bold"
            >*Nombre:</label
          >
          <Field
            type="text"
        ...
        <div class="flex flex-col w-full">
          <label for="apellido" class="text-[#ad988e] font-helvetica font-bold"
            >*Apellido:</label
          >
          <Field
            type="text"
      ...
      <div
        id="row"
        class="py-2 flex flex-col gap-4 md:flex-row items-end justify-center"
      >
        <div class="flex flex-col w-full">
          <label for="email" class="text-[#ad988e] font-helvetica font-bold"
            >*Email:</label
          >
          <Field
            type="email"
      ...
      >
        <div class="w-full">
          <label for="phonecode" class="text-[#ad988e] font-helvetica font-bold"
            >Teléfono</label
          >
          <label
            for="phonenumber"
            class="text-[#ad988e] font-helvetica font-bold"
          ></label>
      ...
      <div id="row" class="py-2">
        <label for="year" class="text-[#ad988e] font-helvetica font-bold"
          >País</label
        >
        <SelectInput
          :class="Color"
      ...
      <div id="row" class="py-2">
        <label for="year" class="block mb-1 font-bold text-[#ad988e]"
          >Región</label
        >
        ...
        <h2 v-if="model.region == ''" class="text-red-700">
          Debes escoger una región
        </h2>
      </div>
