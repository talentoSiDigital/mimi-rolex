...
<template>
  <main>
    ...
    <div class="flex items-center justify-center gap-24 h-[80vh]">
      ...
      <div class="w-1/2 flex flex-col items-center">
        ...
        <h2 class="text-xl">
          Toda la información referente a la misma, asi como los pasos a seguir
          para retirar ha sido enviada a tu cuenta de correo
        </h2>
