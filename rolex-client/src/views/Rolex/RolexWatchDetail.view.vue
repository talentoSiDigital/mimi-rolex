                ...
                <div v-if="isReady" class="mb-44">
                    ...
                    <section class="bg-[#f8f8f8] flex flex-col justify-center items-center">
                        ...
                        <h1 class="leading-relaxed text-md w-10/12 md:w-7/12 text-justify md:text-center pb-16">
                            ...
                            modelos Rolex.
                            <br>
                            Los nuevos relojes Rolex están disponibles exclusivamente en los distribuidores oficiales, que
                            se surten con regularidad y gestionan de manera independiente la distribución y las ventas de
                    ...
                    <ContactWatchRolex :message="`Me interesa el Rolex ${state.getAll.nombre} (Modelo de referencia ${state.getAll.modelo})`"/>
