        ...
        <RolexTemplate>
            <template #content>
                ...
                <RolexHeader>
                    ...
                    <template #text>
                        En el corazón de la filosofía y las actividades de Rolex reside una visión a largo plazo. El
                        concepto de sostenibilidad siempre ha sentado los cimientos del desarrollo de la marca: ofrecer
                        relojes atemporales y duraderos creados para perdurar, a la vez que se compromete con las
                        generaciones futuras mediante varias colaboraciones, iniciativas y medidas.
                        <br>
                        <br>
                        Este enfoque refleja la filosofía «Perpetual» que ha impulsado a la empresa desde su creación. Una
                        filosofía que reúne las destrezas de muchos y requiere un arduo trabajo, día tras día, año tras año.
                ...
                <div class="aspect-w-16 aspect-h-9">
                    <iframe  src="https://www.youtube.com/embed/OE0E8BmrvnI?si=pDa7Q5eZsFQf3Ac6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
