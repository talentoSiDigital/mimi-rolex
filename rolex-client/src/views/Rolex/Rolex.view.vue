    ...
    <RolexTemplate>
        <template #content>
            ...
            <section class="bg-rolex-brown-light-2 flex flex-col justify-center items-center pb-[10vh]">
                ...
                <div class="w-11/12">
                    <SectionNavigationCard img="discover-rolex/discover-rolex-1" :link="{name:'coleccion-rolex'}"
                        class="w-full ">
            ...
            <section class="bg-rolex-brown-light-2 flex flex-col justify-center items-center pb-10">
                ...
                <div class="w-11/12 flex flex-col md:flex-row gap-2">
                    ...
                    <SectionNavigationCard img="discover-rolex/discover-rolex-5" :link="{name:'rolex-watchmaking'}"
                        class="w-full md:w-1/3 ">
                    ...
                    <SectionNavigationCard img="discover-rolex/discover-rolex-6" :link="{name:'mantenimiento-rolex'}"
                        class="w-full md:w-1/3 ">
