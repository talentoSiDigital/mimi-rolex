        ...
        <template #content>
            <section class="py-[10vh] bg-rolex-brown-light-1">
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-1.webp" alt="article-1"
                        class="hidden md:block w-10/12">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-1-mobile.webp"
            ...
            <section class=" bg-rolex-brown-light-1">
                <header
                    class="flex flex-col gap-8 font-helvetica font-bold justify-around items-center  text-rolex-brown h-fit pb-[10vh]">
            ...
            <section class="pb-[10vh] bg-rolex-brown-light-1">
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-2.webp" alt="article-2"
                        class="hidden md:block w-10/12 md:w-1/2">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-2-mobile.webp"
                        alt="article-2-mobile" class="md:hidden block w-10/12 md:w-1/2">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-3.webp" alt="article-3"
                        class="hidden md:block w-10/12 md:w-1/2">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-3-mobile.webp"
                        alt="article-3-mobile" class="md:hidden block w-10/12 md:w-1/2">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-4.webp" alt="article-4"
                        class="hidden md:block ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-4-mobile.webp"
                        alt="article-4-mobile" class="md:hidden block">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-5.webp" alt="article-5"
                        class="hidden md:block w-10/12 md:w-1/2">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-5-mobile.webp"
                        alt="article-5-mobile" class="md:hidden block w-10/12 md:w-1/2">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-6.webp" alt="article-6"
                        class="hidden md:block w-10/12 ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-6-mobile.webp"
                        alt="article-6-mobile" class="md:hidden block w-10/12 ">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-7.webp" alt="article-7"
                        class="hidden md:block w-full">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-7-mobile.webp"
                        alt="article-7-mobile" class="md:hidden block w-full ">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-8.webp" alt="article-8"
                        class="hidden md:block w-10/12 ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-8-mobile.webp"
                        alt="article-8-mobile" class="md:hidden block w-10/12 ">
                </div>
                ...
                <div class="flex justify-center ">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-9.webp" alt="article-9"
                        class="hidden md:block w-10/12 md:w-1/2">
                    <img src="/assets/routes-assets/world-of-rolex/articles/article-1/article-9-mobile.webp"
                        alt="article-9-mobile" class="md:hidden block w-10/12 md:w-1/2">
                </div>
