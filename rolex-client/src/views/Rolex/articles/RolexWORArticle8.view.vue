    ...
    <template #content>
      ...
      <section class="bg-rolex-brown-light-1 pb-[10vh]">
        <div class="flex justify-center pb-[10vh]">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-0.webp" alt="article-0"
            class="hidden md:block w-10/12" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-0-mobile.webp"
        ...
        <div class="flex justify-center pb-[10vh]">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-1.webp" alt="article-1"
            class="hidden md:block w-full" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-1-mobile.webp"
            alt="article-1-mobile" class="md:hidden block w-10/12 md:w-1/2" />
        </div>
        ...
        <div class="flex justify-center">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-2.webp" alt="article-2"
            class="hidden md:block w-9/12" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-2-mobile.webp"
        ...
        <div class="flex justify-center">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-3.webp" alt="article-3"
            class="hidden md:block w-9/12" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-3-mobile.webp"
        ...
        <header
          ...
          <p class="w-10/12 md:w-1/2 text-xl font-helvetica font-light text-justify md:text-left">
            ...
            partidos por la noche hasta la implementación del ojo de halcón —un
            sistema de arbitraje digital que realiza las llamadas de línea de
            forma inmediata—, se hace todo lo posible para garantizar que el
            torneo siga siendo tan atractivo como siempre.
          </p>
        </header>

        <div class="flex justify-center">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-4.webp" alt="article-5"
            class="hidden md:block w-1/2" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-4-mobile.webp"
        ...
        <header
          ...
          <p class="w-10/12 md:w-1/2 text-xl font-helvetica font-light text-justify md:text-left">
            ...
            excelencia, la pasión por la precisión y la innovación, la elegancia
            del movimiento, un esfuerzo inquebrantable, el respeto por la
            tradición y una motivación por siempre sobrepasar los límites
            personales.
          </p>
        </header>
        <div class="flex justify-center">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-5.webp" alt="article-3"
            class="hidden md:block w-full" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-5-mobile.webp"
        ...
        <header
          ...
          <p class="w-10/12 md:w-1/2 text-xl font-helvetica font-light text-justify md:text-left">
            ...
            los cuatro torneos de Grand Slam®, el ATP y el WTA Finals, que ponen
            fin a la temporada, todos los torneos ATP Masters 1000 y nueve de
            los eventos WTA 1000 de alto rango, así como las principales
            competiciones por equipos a nivel internacional; la Copa Davis y la
            Laver Cup.
          </p>
        </header>
        <div class="flex justify-center">
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-6.webp" alt="article-3"
            class="hidden md:block w-1/2" />
          <img src="/assets/routes-assets/world-of-rolex/articles/article-8/article-6-mobile.webp"
            alt="article-3-mobile" class="md:hidden block w-10/12" />
        </div>
      </section>

      <section class="flex justify-center w-full bg-rolex-brown-light-1 pb-[10vh]">
        <SectionNavigationCard img="banners/new-banner-collections-datejust" link="/coleccion-rolex/datejust"
          class="w-10/12">
