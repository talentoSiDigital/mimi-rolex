...
<template>
  <div id="relojeria" class="my-20 text-gray-600">
    <div
      class="mb-10 flex flex-col md:flex-row items-center justify-center w-full"
    >
      <!-- The left line -->
    ...
    <div class="flex flex-col md:flex-row items-center justify-center gap-10">
      ...
      <div class="w-10/12 md:w-1/3">
        <div class="w-full flex flex-col gap-6">
          ...
          <a
            href="https://maps.app.goo.gl/FemKdGHF9r7tBANW6"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/inversionesmimijoyeria/"
            target="_blank"
            class="flex items-center gap-6 text-xl cursor-pointer"
          >
          ...
          <a
            href="https://www.instagram.com/mimijoyeria/"
            target="_blank"
            class="flex items-center gap-6 text-xl cursor-pointer"
          >
    ...
    >
      ...
      <div class="flex flex-col gap-2 w-10/12 md:w-2/3">
        ...
        <Field
          ...
          rows="10"
          placeholder="Mensaje"
          class="bg-neutral-100 h-24 p-4"
          v-model="message"
        />
        <ErrorMessage name="message" class="text-red-700" />
        <button
          class="border bg-[#adbaad] text-white h-14 hover:bg-white hover:text-[#adbaad] duration-150"
        >
          Enviar mensaje
        </button>
      </div>
