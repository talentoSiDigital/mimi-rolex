...
<template>
    <div id="main-container">
        ...
        <header class="flex flex-col justify-center font-black items-center  h-fit py-10 bg-neutral-100">
            <p class="font-black text-xl text-red-700 stroke-black">
                ADÉNTRESE EN TUDOR
            </p>
            ...
            <p class="w-3/4 text-center font-normal mb-14">
            ...
            <div id="button" class="relative  py-2 px-14 bg-red-700">
                ...
                <a href="#"
                    ...
                    <p class="text-sm ">VER COLECCIÓN</p>
        ...
        <section class=" flex flex-col items-center justify-center py-10  ">
            ...
            <h1 class="text-4xl py-4 font-black">
        ...
        <section class="flex flex-col md:flex-row w-full h-fit mb-14 bg-[#1a1a18]">
            <div class="md:w-1/2 py-10 flex flex-col justify-center items-center text-white ">
                ...
                <p class="font-black text-xl w-5/6">
                    HISTORIA DE TUDOR
                </p>
                <h1 class="text-4xl py-4 font-black w-5/6">
                    EL ARTE DEL MONTAJE
        ...
        <section class="flex flex-col md:flex-row-reverse justify-around items-center p-10 w-full">
            ...
            <header class="w-[40%]">
                <h3 class="font-black text-xl text-red-700">EMBAJADOR TUDOR</h3>
                <h1 class="text-4xl py-4 font-black">DAVID BECKHAM</h1>
        ...
        <section class="flex flex-col md:flex-row justify-around items-center p-10 w-full">
            ...
            <header class="w-[40%]">
                <h3 class="font-black text-xl text-red-700">EMBAJADOR TUDOR</h3>
                <h1 class="text-4xl py-4 font-black">JAY CHOU</h1>
        ...
        <section class=" h-[300px] w-full overflow-hidden bg-black relative">
            ...
            <header
                ...
                <h1 class="text-xl md:text-4xl  text-center  py-4 w-3/4">
        ...
        <section class="pb-16 w-full overflow-hidden gap-6 bg-black relative flex flex-col justify-center items-center">
            ...
            <header class="font-black h-full flex flex-col  md:flex-row items-center justify-center  text-white bg-black bg-opacity-40 ">

                <h1 class="text-red-700 p-4 md:p-6">TUDOR EN MIMI JOYERÍA</h1>
                <a href="https://tienda.mimijoyeria.com/collections/tudor" target="_blank" class="hover:text-red-700 duration-200 border-t border-b border-white  md:border-black p-4 md:p-6">QUIERO UN TUDOR</a>
