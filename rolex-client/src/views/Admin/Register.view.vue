...
<template>
  <section class="bg-gray-200 w-full py-20">
    ...
    >
      ...
      <div
        class="md:w-1/2 bg-white rounded-lg shadow-sm md:mt-0 sm:max-w-md md:max-w-none xl:p-0"
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1
            class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-4xl"
          >
            Registrar
          </h1>
          ...
          <Form
            ...
            @submit="handleRegister(user, phoneNumber)"
          >
